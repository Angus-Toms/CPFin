...
int main() {
	testModel("test/benchmarks/ar(5)_", 0, 5);
	testModel("test/benchmarks/ar(25)_", 0, 25);
	testModel("test/benchmarks/ma(5)_", 1, 5);
	testModel("test/benchmarks/ma(25)_", 1, 25);
	testModel("test/benchmarks/arma(5,5)_", 2, 5);
	testModel("test/benchmarks/arma(25,25)_", 2, 25);
